import { PenIcon, LockIcon } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <form className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-2 border border-black bg-white text-black py-3 px-4 hover:bg-gray-50 transition duration-200"
            >
              <svg
                version="1.1"
                width="18"
