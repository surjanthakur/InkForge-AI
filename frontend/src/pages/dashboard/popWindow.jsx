    ...
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="z-50 absolute right-0 mt-2 w-44 bg-white border border-gray-100 rounded-lg shadow-lg flex flex-col">
          <button className="text-sm px-4 py-2 text-gray-800 hover:bg-gray-50 rounded-t-lg text-left">
            Download as PDF
          </button>
          <button className="text-sm px-4 py-2 text-gray-800 hover:bg-gray-50 rounded-b-lg text-left">
            Download as Image
          </button>
        </div>
      )}
